...
getTeamPlayers:app.get("/get-team-players/:id", (req, res) => {
  ...
  var options = {
    method: "GET",
    url:
      "https://dev132-cricket-live-scores-v1.p.rapidapi.com/playersbyteam.php",
    params: { teamid: id },
    headers: {
  ...
  axios
    ...
    .then(function (response) {
      //console.log(response.data.teamPlayers.players);
      res.send(response.data.teamPlayers.players);
    })
